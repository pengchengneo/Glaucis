"""Auto-generated Glaucis template for L1 problem 59: conv_standard_3D__asymmetric_input__square_kernel."""
...
def get_inputs():
    ...
    x = jax.random.uniform(key, shape=(batch_size, in_channels, height, width, depth))
    return [x]
