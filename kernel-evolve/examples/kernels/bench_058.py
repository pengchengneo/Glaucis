"""Auto-generated Glaucis template for L1 problem 58: conv_transposed_3D__asymmetric_input__asymmetric_kernel."""
...
def get_inputs():
    ...
    x = jax.random.uniform(key, shape=(batch_size, in_channels, depth_in, height_in, width_in))
    return [x]
